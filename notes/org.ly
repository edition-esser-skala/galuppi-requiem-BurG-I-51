...
KyrieIIBassFigures = \figuremode {
  ...
  <5 3>4 <6 4> <6 4! 3>2
  <6> <6 5>
  <6 5>4 <5 _!> r8 <6!> \bo <[6]> \bc <[6!]>
  r2 <6> %165
  <5 3>4 <6 4> <6 4! _->2
  <6>2 <6>8 <5> r4
  <6 5 _-> <_!> r8 <6!> \bo <[6]> \bc <[6!]>
  r2 <[6]>
...
RexTremendaeBassFigures = \figuremode {
  r2 r8 \bo <[6]>4 \bc <[_!]>8 %366
  r2 <4+>4 <6>
  <6>8 <5> <9 4> <8 3> \bo <[6] 4> \bc <[5] _!> r <6 4!>
  <6>4 \bo <[_-]>8 \bc <[6]> <6 4>4 <5 _!>
  r2 r8 \bo <[6]>4 \bc <[_!]>8 %370
  r2 <4+>4 <6>
  <6>8 <5> <9 4> <8 3> \bo <[6] 4> \bc <[5] _!> r <6 4!>
  <6>2 <_->
  <_!> <7 [_!]>4 <[6 5]>
  ...
  r2 r8 <[6]>4.
  r2 <4!>4 <6> %385
  <6>8 <[5-]> \bo <9 [4]> \bc <8 [3]> \bo <[6] 4> <5 3> r <2>
  <6>4. \bc <[6-]>8 <6 4>4 <5 _!>
  r2 r8 <[6]>4.
  r2 <4!>4 <6>
  <6>8 <5-> <9> <8> <4> <3> <4>4 %390
  <6>1
  r2 <7->4 <5->
  \bo <[9 4-]>8 \bc <[8 3]> <6>4 <7 [5!] _+> <6>
  r8 <_!>4 <[4!]>8 <6>4 <6!>
  r4 \bo <[5-]>8 \bc <[\t]> <4>4 <3> %395
  <5> <5>8 <6> <_!>2
  <_!>4 <8>8 <7> r2
  r4. <[6]>8 <_!>2
  r4 <5>8 <6> <4>4 <_!>
  ...
  <6- 4 2>4 <7- 5 3> <[_-]>2
  <7>4 <6> <7 5 _!>4. <_->8
  <6- 4> <5 _!> r4 \bo <[5 _!]> <6- 4>8 \bc <[5 _!]> %405
  <6- 4>4 <7- 5> <_!>2
  r <7>8 <6> r4
  <7>8 <6-> r4 <7! _->8 <6-> r4
  <6>4 <6>8 <5> <4> <_-> <6> <5->
  ...
  r2 <7->
  r2. <6>8. <5>16 %415
  <5 _->4 <6-> <6! 5->4 \bo <[_-]>8. <7->16
  \bc <[_!]>4 <_-> <9- _!>8 <8> r8. <6 _->16
  \bo <[_-]>4 <6>8. \bc <[_-]>16 <5 4>4 <\l _!>
  <[_-]>2 <7- 5>4 \bo <[_-]>8 \bc <[5-]>
...
OroSupplexBassFigures = \figuremode {
  ...
  r2 r8 <[5-]>4.
  r1
  r8 <6> \bo <[_-]>4 \bc <[6]>8 <7-> r <6-> %705
  <6> <5> <5 4> <\l 3> r2
  <6 4>4 <5 3> r <[6]>
  r q <6 4 2>2
  <7 5 _!>1
  <6->4. <5>8 \bo <[5!] _!>4. <\t>8 %710
  \bc <[6]>4 <5> <6> r
  <_-> <5> <6> r
  r4 <5> <6> <6>8 <5>
  r4. <[2]>8 <6> <5> \bo <[5!] _+>4
...
DomineIesuBassFigures = \figuremode {
  ...
  <_+> %50
  r
  <5 4>4 \bassFigureExtendersOn <5 _+>8 \bo <5 [2+]> \bc <5 [_+]>4 \bassFigureExtendersOff
  r2. %53 finis
}
